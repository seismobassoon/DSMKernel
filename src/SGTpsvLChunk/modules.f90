...
!-------------------------<< input matrix >>----------------------------------
  !include 'mpif.h'  
  character(200) :: outputDir, psvmodel, modelname,DSMconfFile 
  character(200) :: list,list1
...
subroutine bcast_allocate_1
  ...
  call MPI_BCAST(maxMemoryInGigabyte,1,MPI_DOUBLE_PRECISION,0,MPI_COMM_WORLD,ierr)
  
  call MPI_BCAST(outputDir,200,MPI_CHARACTER,0,MPI_COMM_WORLD,ierr)
