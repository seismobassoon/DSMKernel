...
subroutine localMetaComputeKernel
  use localParamKernel
  use parametersKernel
  use tmpSGTs
  use angles
  ...
  return
end subroutine localMetaComputeKernel


subroutine compileKernelOutput
  use localParamKernel
  use parametersKernel
  use tmpSGTs
  use angles
  ...
  deallocate(totalker)
  return
end subroutine compileKernelOutput


subroutine finalLogMessage
  use localParamKernel
  use parametersKernel
  use tmpSGTs
  use angles
  ...
  return
end subroutine finalLogMessage
