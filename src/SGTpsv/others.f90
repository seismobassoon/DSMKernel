...
subroutine calstg_for_stackpoints(r,nzone,vrmin,vrmax,rrho,vpv,vph,vsv,vsh,eta,qmu,qkappa,lambda,qkp)
...
subroutine calupfluid(c1,omega,lambda,qkp,ylm,strain)
  implicit none
